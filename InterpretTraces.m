...
[Xdim,Ydim,NumFrames,AmplitudeThresholdCoeff,CorrPthresh,MaxGapFillLen,...
    ...
    'ROIoverlapthresh','MinPSALen','MinNumPSAepochs','SampleRate');
...
save('FinalOutput.mat','NeuronActivity','NumNeurons','NeuronTraces','NeuronPixelIdxList',...
    'NeuronAvg','NeuronFrameList','NeuronImage','NeuronObjList','NeuronROIidx',...
    'Trans2ROI','PSAbool','BinSim','SampleRate');
