function [] = Make_ZscoreMovie(moviefile,outfile)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
disp('applying the Zscore normalization to a movie');
...
for i = 1:NumChunks
    ...
    FrameChunk(isnan(FrameChunk)) = 0;
    NewChunk = (FrameChunk-avgframe)./stdframe;
