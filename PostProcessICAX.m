...
for i = 1:length(GoodICidx)
    [TSignalThresh(i),Tx{i},Ty{i}] = NumContourPeaks(GoodICf{i});
end

d = date; % today's date
scriptname = mfilename('fullpath');
filestruct = dir([scriptname,'.m']);
save PPICAX.mat GoodSignalTrace GoodCom GoodICf ThreshIC GoodIC GoodX GoodY Tx Ty GoodCellIC NoiseMask COM d scriptname filestruct t;
