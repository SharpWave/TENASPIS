...
T_PARAMS.MinNumFrames = 2; % minimum number of frames for transient to be included. EDIT:TIME
...
T_PARAMS.SmoothSize = 3;                     % length of window for temporal smoothing of traces.  EDIT:SPACE
